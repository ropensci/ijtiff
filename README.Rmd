...
* On __Debian Linux__, try `sudo apt-get install libtiff-dev libdeflate-dev libwebp-dev libzstd-dev zlib1g-dev`.
* On __Fedora Linux__, try `sudo yum install libtiff-devel libdeflate-devel libwebp-devel libzstd-devel zlib-devel`.
