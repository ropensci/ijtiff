...
* On __Debian Linux__, try `sudo apt-get install libtiff-dev libwebp-dev libzstd-dev`.
* On __Fedora Linux__, try `sudo yum install libtiff-devel libwebp-devel libzstd-devel`.
