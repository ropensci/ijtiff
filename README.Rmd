...
* On 64-bit __Windows__, no setup is required `r emo::ji("smile")`. **If you have 32-bit windows, the `ijtiff` package doesn't work.** I worked really hard to figure out why this is, but I couldn't `r emo::ji("frown")`.
